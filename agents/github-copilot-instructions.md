...
- Apply least privilege during every planning phase. Inspect current org permissions for affected users/personas with `access-inspect` before proposing access changes; if unsure which permission to grant, ask the user explicitly.
