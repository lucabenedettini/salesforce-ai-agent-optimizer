...
| Agentforce, Salesforce Agent, agent topic/action/instruction, Prompt Builder, agent user, agent permissions, agent publish/activation | `references/specialized-guidance/agentforce.md`, `references/least-privilege-planning.md`, `references/privacy-security.md`, `references/testing-and-manifest-guardrails.md` |
