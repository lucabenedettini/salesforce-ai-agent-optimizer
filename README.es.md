...
- Fusiona `agents/claude-code.md` en `CLAUDE.md`.
...
- Fusiona `agents/github-copilot-instructions.md` en `.github/copilot-instructions.md`, o usa `.github/instructions/salesforce-agent-optimizer.instructions.md`.
