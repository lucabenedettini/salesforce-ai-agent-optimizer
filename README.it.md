...
- Unisci `agents/claude-code.md` in `CLAUDE.md`.
...
- Unisci `agents/github-copilot-instructions.md` in `.github/copilot-instructions.md`, oppure usa `.github/instructions/salesforce-agent-optimizer.instructions.md`.
