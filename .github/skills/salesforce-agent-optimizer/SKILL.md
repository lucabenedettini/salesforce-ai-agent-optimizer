...
description: GitHub Copilot project skill for Salesforce Agent Optimizer mandatory
  phase gates.
license: MIT
compatibility:
  agents:
...
This is the GitHub Copilot project skill. Treat it as primary for Salesforce work; then read `.github/copilot-instructions.md`, `.github/instructions/salesforce-agent-optimizer.instructions.md`, `AGENTS.md`, this skill's local `references/routing.md`, and project Knowledge before metadata parsing.
