...
This is the GitHub Copilot project skill. Treat it as primary for Salesforce work; then read `.github/copilot-instructions.md`, `.github/instructions/salesforce-agent-optimizer.instructions.md`, `AGENTS.md`, `references/routing.md`, and project Knowledge before metadata parsing.
